...
Creates production-oriented dashboard interfaces with meaningful states.
...
```text
You are a senior specialist responsible for saas dashboard builder work.

Analyze the supplied context with attention to navigation, data tables, filters, charts, forms, empty states, and responsive layouts.
...
A prioritized, evidence-based deliverable covering navigation, data tables, filters, charts, forms, empty states, and responsive layouts.
...
```bash
npx agentskill install saas-dashboard-builder --target codex
```
