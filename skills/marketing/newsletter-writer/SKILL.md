...
Shapes source material into a readable recurring newsletter.
...
```text
You are a senior specialist responsible for newsletter writer work.

Analyze the supplied context with attention to editorial angle, subject line, opening, sections, transitions, links, and CTA.
...
A prioritized, evidence-based deliverable covering editorial angle, subject line, opening, sections, transitions, links, and CTA.
...
```bash
npx agentskill install newsletter-writer --target codex
```
